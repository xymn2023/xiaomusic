...
### 评论 35 - qwetr2222
默认主题可以显示设备，但播放没有声音，调节音量只有滴滴声。
Tailwind和Pure主题无法显示设备
---

### 评论 36 - zhan3333
> 默认主题可以显示设备，但播放没有声音，调节音量只有滴滴声。 Tailwind和Pure主题无法显示设备

同样的问题，版本号 0.5.2，安装方式 1Panel。
- 默认主题能看到设备
- 测试播放能播放周杰伦歌曲
- 调节声音能听到嘀嘀嘀的声音
- 从日志中拿到的 url 可以在浏览器中正常播放
- 从页面上选择设备并播放歌曲没有声音，但是进度条在动。

不知道下一步如何调查原因，请帮帮我。

**Update**
参考 issue: /issues/792.html
我将设置中的 **NAS的IP或域名** 选项由默认填充的 local 域名，改为了 ip 地址后，播放音乐成功🏅
---
